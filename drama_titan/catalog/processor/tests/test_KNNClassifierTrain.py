...
from drama_titan.catalog.processor.ml.KNNClassifierTrain import execute
from drama_titan.catalog.processor.tests import RESOURCES
from drama_titan.model import MlModelKNN


class KNNClassifierTrainTestCase(unittest.TestCase):
    def setUp(self) -> None:
        task_id, task_name = "drama", "test_KNNClassifierTrain"
