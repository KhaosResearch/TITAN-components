...
from drama_titan.catalog.processor.ml.GenericSlidingWindowClassifierTest import execute
from drama_titan.catalog.processor.tests import RESOURCES


class ClassifierTestTestCase(unittest.TestCase):
    def setUp(self) -> None:
        task_id, task_name = "drama", "test_GenericSlidingWindowClassifierTest"
